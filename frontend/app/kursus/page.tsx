    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="md: ml-[350px]">
                <p className="text-[45px]">kursus</p>
                <p className="text-[20px]">Ayo pilih kursusmu</p>
            </div>
            <div className="md: ml-[350px] md: mr-[300px] md: mt-[50px] flex flex-col gap-20">
                <div className="bg-[#585FC6] md: pt-[60px] md: pb-[60px] rounded-[50px]"><p className="md: text-[25px] md: ml-[100px] text-white">UI UX DESIGN</p></div>
                <div className="bg-[#454C4F] md: pt-[60px] md: pb-[60px] rounded-[50px]"><p className="md: text-[25px] md: ml-[100px] text-white">FRONTEND</p></div>
                <div className="bg-[#FB7171] md: pt-[60px] md: pb-[60px] rounded-[50px]"><p className="md: text-[25px] md: ml-[100px] text-white">BACKEND</p></div>
            </div>
            </main>
