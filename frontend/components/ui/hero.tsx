        ...
        <section className="md:mt-[103px]">
            {isLoggedIn ? (
                ...
                <div className="bg-[#D9D9D9] md:h-[546px]">
                    ...
                    <button className="bg-[#112F58] text-white md:pl-[19px] md:pr-[19px] md:pt-[12px] md:pb-[12px] rounded-[12px] md:ml-[170px] md:mt-[90px] hover:bg-[#0D2342] cursor-pointer">Bergabung sekarang</button>
                </div>
            )}
        </section>
    )
